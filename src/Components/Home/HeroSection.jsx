          ...
          <div className="space-y-8">
            ...
            <RevealAnimation direction="up" delay={0.4} offset={100}>
              <div className="space-y-4">
                <h1 className="text-4xl uppercase sm:text-4xl md:text-4xl lg:text-6xl xl:text-7xl max-w-full sm:max-w-md lg:max-w-[25rem] font-bold leading-10 sm:leading-14 lg:leading-16 text-gray-900 dark:text-white">
                  Innovate
                  <br />
